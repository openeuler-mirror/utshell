...
#[no_mangle]
pub fn initialize_shell_variables(mut env: *mut *mut libc::c_char, mut privmode: libc::c_int) {
...
#[no_mangle]
pub fn adjust_shell_level(mut change: libc::c_int) {
...
#[no_mangle]
pub fn sh_set_lines_and_columns_out(mut lines: libc::c_int, mut cols: libc::c_int) {
...
#[no_mangle]
pub fn print_var_list(mut list: *mut *mut SHELL_VAR) {
...
#[no_mangle]
pub fn print_func_list(mut list: *mut *mut SHELL_VAR) {
...
pub fn print_var_value(mut var: *mut SHELL_VAR, mut quote: libc::c_int) {
    unsafe {
...
#[no_mangle]
pub fn print_var_function(mut var: *mut SHELL_VAR) {
    unsafe {
...
fn get_self(mut self_0: *mut SHELL_VAR) -> *mut SHELL_VAR {
    return self_0;
}

fn init_dynamic_array_var(
    mut name: *mut libc::c_char,
    mut getfunc: Option<sh_var_value_func_t>,
    mut setfunc: Option<sh_var_assign_func_t>,
...
fn get_seconds(mut var: *mut SHELL_VAR) -> *mut SHELL_VAR {
...
fn get_random(mut var: *mut SHELL_VAR) -> *mut SHELL_VAR {
    let mut rv: libc::c_int = 0;
    let mut p: *mut libc::c_char = 0 as *mut libc::c_char;
...
fn get_lineno(mut var: *mut SHELL_VAR) -> *mut SHELL_VAR {
    let mut p: *mut libc::c_char = 0 as *mut libc::c_char;
...
fn get_subshell(mut var: *mut SHELL_VAR) -> *mut SHELL_VAR {
    let mut p: *mut libc::c_char = 0 as *mut libc::c_char;
    unsafe {
...
fn get_epochseconds(mut var: *mut SHELL_VAR) -> *mut SHELL_VAR {
...
fn get_epochrealtime(mut var: *mut SHELL_VAR) -> *mut SHELL_VAR {
...
fn get_bashpid(mut var: *mut SHELL_VAR) -> *mut SHELL_VAR {
    let mut pid: libc::c_int = 0;
    let mut p: *mut libc::c_char = 0 as *mut libc::c_char;
    unsafe {
        pid = getpid();
...
fn get_bash_argv0(mut var: *mut SHELL_VAR) -> *mut SHELL_VAR {
    let mut p: *mut libc::c_char = 0 as *mut libc::c_char;
    unsafe {
...
fn get_bash_command(mut var: *mut SHELL_VAR) -> *mut SHELL_VAR {
    let mut p: *mut libc::c_char = 0 as *mut libc::c_char;
    unsafe {
...
fn get_histcmd(mut var: *mut SHELL_VAR) -> *mut SHELL_VAR {
    let mut p: *mut libc::c_char = 0 as *mut libc::c_char;
...
fn get_comp_wordbreaks(mut var: *mut SHELL_VAR) -> *mut SHELL_VAR {
    unsafe {
...
fn get_dirstack(mut self_0: *mut SHELL_VAR) -> *mut SHELL_VAR {
...
fn get_groupset(mut self_0: *mut SHELL_VAR) -> *mut SHELL_VAR {
    let mut i: libc::c_int = 0;
...
fn get_bashargcv(mut self_0: *mut SHELL_VAR) -> *mut SHELL_VAR {
...
fn build_hashcmd(mut self_0: *mut SHELL_VAR) -> *mut SHELL_VAR {
...
fn get_hashcmd(mut self_0: *mut SHELL_VAR) -> *mut SHELL_VAR {
...
fn build_aliasvar(mut self_0: *mut SHELL_VAR) -> *mut SHELL_VAR {
    let mut h: *mut HASH_TABLE = 0 as *mut HASH_TABLE;
    let mut i: libc::c_int = 0;
    let mut k: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut v: *mut libc::c_char = 0 as *mut libc::c_char;
...
fn get_aliasvar(mut self_0: *mut SHELL_VAR) -> *mut SHELL_VAR {
...
fn get_funcname(mut self_0: *mut SHELL_VAR) -> *mut SHELL_VAR {
    return self_0;
}

#[no_mangle]
pub fn make_funcname_visible(mut on_or_off: libc::c_int) {
    let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
...
fn hash_lookup(mut name: *const libc::c_char, mut hashed_vars: *mut HASH_TABLE) -> *mut SHELL_VAR {
...
#[no_mangle]
pub fn var_lookup(mut name: *const libc::c_char, mut vcontext: *mut VAR_CONTEXT) -> *mut SHELL_VAR {
    let mut vc: *mut VAR_CONTEXT = 0 as *mut VAR_CONTEXT;
    let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
...
fn find_variable_internal(mut name: *const libc::c_char, mut flags: libc::c_int) -> *mut SHELL_VAR {
    let mut var: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
...
fn find_nameref_at_context(mut v: *mut SHELL_VAR, mut vc: *mut VAR_CONTEXT) -> *mut SHELL_VAR {
    let mut nv: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
...
#[no_mangle]
pub fn find_variable_tempenv(mut name: *const libc::c_char) -> *mut SHELL_VAR {
    let mut var: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
...
#[no_mangle]
pub fn find_variable_notempenv(mut name: *const libc::c_char) -> *mut SHELL_VAR {
    let mut var: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
...
#[no_mangle]
pub fn find_global_variable(mut name: *const libc::c_char) -> *mut SHELL_VAR {
    let mut var: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    unsafe {
...
#[no_mangle]
pub fn find_global_variable_noref(mut name: *const libc::c_char) -> *mut SHELL_VAR {
    let mut var: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    unsafe {
        var = var_lookup(name, global_variables);
        if var.is_null() {
...
#[no_mangle]
pub fn find_shell_variable(mut name: *const libc::c_char) -> *mut SHELL_VAR {
    let mut var: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    unsafe {
        var = var_lookup(name, shell_variables);
        if !var.is_null() && nameref_p!(var) != 0 {
...
#[no_mangle]
pub fn find_variable_no_invisible(mut name: *const libc::c_char) -> *mut SHELL_VAR {
    let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    let mut flags: libc::c_int = 0;
    unsafe {
        last_table_searched = 0 as *mut HASH_TABLE;
...
#[no_mangle]
pub fn find_variable_for_assignment(mut name: *const libc::c_char) -> *mut SHELL_VAR {
    let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    let mut flags: libc::c_int = 0;
    unsafe {
        last_table_searched = 0 as *mut HASH_TABLE;
...
#[no_mangle]
pub fn find_variable_noref(mut name: *const libc::c_char) -> *mut SHELL_VAR {
    let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    let mut flags: libc::c_int = 0;
    unsafe {
        flags = 0 as libc::c_int;
...
#[no_mangle]
pub fn find_function(mut name: *const libc::c_char) -> *mut SHELL_VAR {
    unsafe {
...
#[no_mangle]
pub fn find_function_def(mut name: *const libc::c_char) -> *mut FUNCTION_DEF {
    unsafe {
...
#[no_mangle]
pub fn get_variable_value(mut var: *mut SHELL_VAR) -> *mut libc::c_char {
    unsafe {
        if var.is_null() {
...
#[no_mangle]
pub fn get_string_value(mut var_name: *const libc::c_char) -> *mut libc::c_char {
    let mut var: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
...
#[no_mangle]
pub fn sh_get_env_value_rename(mut v: *const libc::c_char) -> *mut libc::c_char {
    return get_string_value(v);
}

#[no_mangle]
pub fn validate_inherited_value(mut var: *mut SHELL_VAR, mut type_0: libc::c_int) -> libc::c_int {
    unsafe {
...
#[no_mangle]
pub fn var_sametype(mut v1: *mut SHELL_VAR, mut v2: *mut SHELL_VAR) -> libc::c_int {
    unsafe {
...
#[no_mangle]
pub fn set_if_not(mut name: *mut libc::c_char, mut value: *mut libc::c_char) -> *mut SHELL_VAR {
    let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    unsafe {
        if shell_variables.is_null() {
            create_variable_tables();
...
fn new_shell_variable(mut name: *const libc::c_char) -> *mut SHELL_VAR {
...
fn make_new_variable(mut name: *const libc::c_char, mut table: *mut HASH_TABLE) -> *mut SHELL_VAR {
    let mut entry: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
...
#[no_mangle]
pub fn make_new_array_variable(mut name: *mut libc::c_char) -> *mut SHELL_VAR {
    let mut entry: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
...
#[no_mangle]
pub fn make_new_assoc_variable(mut name: *mut libc::c_char) -> *mut SHELL_VAR {
    let mut entry: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
...
#[no_mangle]
pub fn bind_var_to_int(mut var: *mut libc::c_char, mut val: intmax_t) -> *mut SHELL_VAR {
...
#[no_mangle]
pub fn bind_function(mut name: *const libc::c_char, mut value: *mut COMMAND) -> *mut SHELL_VAR {
    let mut entry: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
...
#[no_mangle]
pub fn assign_in_env(mut word: *mut WORD_DESC, mut flags: libc::c_int) -> libc::c_int {
...
fn dispose_variable_value(mut var: *mut SHELL_VAR) {
    unsafe {
        if function_p!(var) != 0 {
...
#[no_mangle]
pub fn dispose_variable(mut var: *mut SHELL_VAR) {
    if var.is_null() {
        return;
    }
    unsafe {
...
#[no_mangle]
pub fn unbind_variable(mut name: *const libc::c_char) -> libc::c_int {
    let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    let mut nv: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
...
#[no_mangle]
pub fn unbind_nameref(mut name: *const libc::c_char) -> libc::c_int {
    unsafe {
        let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
        v = var_lookup(name, shell_variables);
        if !v.is_null() && nameref_p!(v) != 0 {
...
#[no_mangle]
pub fn unbind_variable_noref(mut name: *const libc::c_char) -> libc::c_int {
    let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    unsafe {
        v = var_lookup(name, shell_variables);
        if !v.is_null() {
...
#[no_mangle]
pub fn check_unbind_variable(mut name: *const libc::c_char) -> libc::c_int {
    let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    v = find_variable(name);
    unsafe {
...
#[no_mangle]
pub fn unbind_func(mut name: *const libc::c_char) -> libc::c_int {
    let mut elt: *mut BUCKET_CONTENTS = 0 as *mut BUCKET_CONTENTS;
...
#[no_mangle]
pub fn unbind_function_def(mut name: *const libc::c_char) -> libc::c_int {
    let mut elt: *mut BUCKET_CONTENTS = 0 as *mut BUCKET_CONTENTS;
...
#[no_mangle]
pub fn delete_var(mut name: *const libc::c_char, mut vc: *mut VAR_CONTEXT) -> libc::c_int {
    let mut elt: *mut BUCKET_CONTENTS = 0 as *mut BUCKET_CONTENTS;
    let mut old_var: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
...
#[no_mangle]
pub fn makunbound(mut name: *const libc::c_char, mut vc: *mut VAR_CONTEXT) -> libc::c_int {
    let mut elt: *mut BUCKET_CONTENTS = 0 as *mut BUCKET_CONTENTS;
...
fn free_variable_hash_data(mut data: *mut libc::c_void) {
    let mut var: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
...
#[no_mangle]
pub fn delete_all_variables(mut hashed_vars: *mut HASH_TABLE) {
    unsafe {
        hash_flush(
            hashed_vars,
...
#[no_mangle]
pub fn set_var_read_only(mut name: *mut libc::c_char) {
    let mut entry: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
...
fn vlist_alloc(mut nentries: libc::c_int) -> *mut VARLIST {
...
fn vlist_realloc(mut vlist: *mut VARLIST, mut n: libc::c_int) -> *mut VARLIST {
    if vlist.is_null() {
        vlist = vlist_alloc(n);
        return vlist;
    }
...
fn vlist_add(mut vlist: *mut VARLIST, mut var: *mut SHELL_VAR, mut flags: libc::c_int) {
    let mut i: libc::c_int = 0;
    i = 0 as libc::c_int;
    unsafe {
...
#[no_mangle]
pub fn map_over_funcs(mut function: Option<sh_var_map_func_t>) -> *mut *mut SHELL_VAR {
    let mut vlist: *mut VARLIST = 0 as *mut VARLIST;
    let mut ret: *mut *mut SHELL_VAR = 0 as *mut *mut SHELL_VAR;
    unsafe {
...
#[no_mangle]
pub fn sort_variables(mut array: *mut *mut SHELL_VAR) {
    unsafe {
        qsort(
...
fn qsort_var_comp(mut var1: *mut *mut SHELL_VAR, mut var2: *mut *mut SHELL_VAR) -> libc::c_int {
...
fn vapply(mut func: Option<sh_var_map_func_t>) -> *mut *mut SHELL_VAR {
...
fn fapply(mut func: Option<sh_var_map_func_t>) -> *mut *mut SHELL_VAR {
    let mut list: *mut *mut SHELL_VAR = 0 as *mut *mut SHELL_VAR;
...
fn visible_var(mut var: *mut SHELL_VAR) -> libc::c_int {
    unsafe {
        if invisible_p!(var) == 0 {
            1 as libc::c_int
        } else {
...
fn visible_and_exported(mut var: *mut SHELL_VAR) -> libc::c_int {
    unsafe {
...
fn export_environment_candidate(mut var: *mut SHELL_VAR) -> libc::c_int {
    unsafe {
...
fn local_and_exported(mut var: *mut SHELL_VAR) -> libc::c_int {
    unsafe {
...
fn variable_in_context(mut var: *mut SHELL_VAR) -> libc::c_int {
    unsafe {
...
fn visible_variable_in_context(mut var: *mut SHELL_VAR) -> libc::c_int {
    unsafe {
        if invisible_p!(var) == 0 as libc::c_int
            && local_p!(var) != 0
            && (*var).context == variable_context
...
#[no_mangle]
pub fn all_local_variables(mut visible_only: libc::c_int) -> *mut *mut SHELL_VAR {
    let mut vlist: *mut VARLIST = 0 as *mut VARLIST;
    let mut ret: *mut *mut SHELL_VAR = 0 as *mut *mut SHELL_VAR;
    let mut vc: *mut VAR_CONTEXT = 0 as *mut VAR_CONTEXT;
    unsafe {
...
fn visible_array_vars(mut var: *mut SHELL_VAR) -> libc::c_int {
    unsafe {
...
#[no_mangle]
pub fn all_variables_matching_prefix(mut prefix: *const libc::c_char) -> *mut *mut libc::c_char {
...
#[no_mangle]
pub fn find_tempenv_variable(mut name: *const libc::c_char) -> *mut SHELL_VAR {
    unsafe {
...
fn push_posix_temp_var(mut data: *mut libc::c_void) {
    let mut var: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
...
fn push_temp_var(mut data: *mut libc::c_void) {
    let mut var: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    let mut binding_table: *mut HASH_TABLE = 0 as *mut HASH_TABLE;
    var = data as *mut SHELL_VAR;
...
fn propagate_temp_var(mut data: *mut libc::c_void) {
    let mut var: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    var = data as *mut SHELL_VAR;
    unsafe {
...
fn dispose_temporary_env(mut pushf: sh_free_func_t) {
    let mut i: libc::c_int = 0;
...
fn make_env_array_from_var_list(mut vars: *mut *mut SHELL_VAR) -> *mut *mut libc::c_char {
    unsafe {
        let mut i: libc::c_int = 0;
...
fn make_var_export_array(mut vcxt: *mut VAR_CONTEXT) -> *mut *mut libc::c_char {
    let mut list: *mut *mut libc::c_char = 0 as *mut *mut libc::c_char;
...
#[no_mangle]
pub fn chkexport(mut name: *mut libc::c_char) -> libc::c_int {
    let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    v = find_variable(name);
    unsafe {
...
#[no_mangle]
pub fn put_command_name_into_env(mut command_name: *mut libc::c_char) {
...
#[no_mangle]
pub fn new_var_context(mut name: *mut libc::c_char, mut flags: libc::c_int) -> *mut VAR_CONTEXT {
    let mut vc: *mut VAR_CONTEXT = 0 as *mut VAR_CONTEXT;
    unsafe {
...
#[no_mangle]
pub fn dispose_var_context(mut vc: *mut VAR_CONTEXT) {
    unsafe {
        if !((*vc).name).is_null() {
...
fn set_context(mut var: *mut SHELL_VAR) -> libc::c_int {
    unsafe {
        (*var).context = variable_context;
        return (*var).context;
    }
...
#[inline]
fn push_posix_tempvar_internal(mut var: *mut SHELL_VAR, mut isbltin: libc::c_int) {
    let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
...
fn push_func_var(mut data: *mut libc::c_void) {
    let mut var: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    var = data as *mut SHELL_VAR;
    push_posix_tempvar_internal(var, 0 as libc::c_int);
}

fn push_builtin_var(mut data: *mut libc::c_void) {
    let mut var: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    var = data as *mut SHELL_VAR;
...
#[no_mangle]
pub fn delete_all_contexts(mut vcxt: *mut VAR_CONTEXT) {
    let mut v: *mut VAR_CONTEXT = 0 as *mut VAR_CONTEXT;
...
#[no_mangle]
pub fn push_scope(mut flags: libc::c_int, mut tmpvars: *mut HASH_TABLE) -> *mut VAR_CONTEXT {
    return push_var_context(0 as *mut libc::c_void as *mut libc::c_char, flags, tmpvars);
}

fn push_exported_var(mut data: *mut libc::c_void) {
    let mut var: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    var = data as *mut SHELL_VAR;
    unsafe {
...
#[no_mangle]
pub fn pop_scope(mut is_special: libc::c_int) {
    let mut vcxt: *mut VAR_CONTEXT = 0 as *mut VAR_CONTEXT;
    let mut ret: *mut VAR_CONTEXT = 0 as *mut VAR_CONTEXT;
...
fn restore_dollar_vars(mut args: *mut *mut libc::c_char) {
    let mut i: libc::c_int = 0;
    i = 1 as libc::c_int;
    unsafe {
        while i < 10 as libc::c_int {
...
fn free_saved_dollar_vars(mut args: *mut *mut libc::c_char) {
    let mut i: libc::c_int = 0;
    i = 1 as libc::c_int;
    unsafe {
        while i < 10 as libc::c_int {
...
#[no_mangle]
pub fn push_args(mut list: *mut WORD_LIST) {
...
fn sv_compare(mut sv1: *mut name_and_function, mut sv2: *mut name_and_function) -> libc::c_int {
    let mut r: libc::c_int = 0;
    unsafe {
...
#[inline]
fn find_special_var(mut name: *const libc::c_char) -> libc::c_int {
    let mut i: libc::c_int = 0;
    let mut r: libc::c_int = 0;
    i = 0 as libc::c_int;
    unsafe {
...
#[no_mangle]
pub fn stupidly_hack_special_variables(mut name: *mut libc::c_char) {
...
#[no_mangle]
pub fn sv_ifs(mut name: *mut libc::c_char) {
    let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
...
#[no_mangle]
pub fn sv_path(mut name: *mut libc::c_char) {
    unsafe {
        phash_flush();
    }
}
...
#[no_mangle]
pub fn sv_mail(mut name: *mut libc::c_char) {
    unsafe {
...
#[no_mangle]
pub fn sv_funcnest(mut name: *mut libc::c_char) {
    let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
...
#[no_mangle]
pub fn sv_execignore(mut name: *mut libc::c_char) {
    unsafe {
...
#[no_mangle]
pub fn sv_globignore(mut name: *mut libc::c_char) {
    unsafe {
...
#[no_mangle]
pub fn sv_comp_wordbreaks(mut name: *mut libc::c_char) {
...
#[no_mangle]
pub fn sv_terminal(mut name: *mut libc::c_char) {
    unsafe {
...
#[no_mangle]
pub fn sv_hostfile(mut name: *mut libc::c_char) {
    let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    v = find_variable(name);
    if v.is_null() {
        clear_hostname_list();
...
#[no_mangle]
pub fn sv_histsize(mut name: *mut libc::c_char) {
    let mut temp: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut num: intmax_t = 0;
...
#[no_mangle]
pub fn sv_histignore(mut name: *mut libc::c_char) {
    setup_history_ignore(name);
}

#[no_mangle]
pub fn sv_history_control(mut name: *mut libc::c_char) {
    let mut temp: *mut libc::c_char = 0 as *mut libc::c_char;
...
#[no_mangle]
pub fn sv_histchars(mut name: *mut libc::c_char) {
    let mut temp: *mut libc::c_char = 0 as *mut libc::c_char;
    temp = get_string_value(name);
    unsafe {
        if !temp.is_null() {
...
#[no_mangle]
pub fn sv_histtimefmt(mut name: *mut libc::c_char) {
    let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    v = find_variable(name);
    unsafe {
        if !v.is_null() {
...
#[no_mangle]
pub fn sv_tz(mut name: *mut libc::c_char) {
    let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
...
#[no_mangle]
pub fn sv_ignoreeof(mut name: *mut libc::c_char) {
...
#[no_mangle]
pub fn sv_optind(mut name: *mut libc::c_char) {
    let mut var: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
...
#[no_mangle]
pub fn sv_opterr(mut name: *mut libc::c_char) {
    let mut tt: *mut libc::c_char = 0 as *mut libc::c_char;
    unsafe {
...
#[no_mangle]
pub fn sv_strict_posix(mut name: *mut libc::c_char) {
    let mut var: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    var = find_variable(name);
    unsafe {
...
#[no_mangle]
pub fn sv_locale(mut name: *mut libc::c_char) {
    let mut v: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut r: libc::c_int = 0;
...
#[no_mangle]
pub fn set_pipestatus_array(mut ps: *mut libc::c_int, mut nproc: libc::c_int) {
    let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    let mut a: *mut ARRAY = 0 as *mut ARRAY;
...
#[no_mangle]
pub fn restore_pipestatus_array(mut a: *mut ARRAY) {
    let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
...
#[no_mangle]
pub fn set_pipestatus_from_exit(mut s: libc::c_int) {
    unsafe {
...
#[no_mangle]
pub fn sv_xtracefd(mut name: *mut libc::c_char) {
    let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    let mut t: *mut libc::c_char = 0 as *mut libc::c_char;
...
#[no_mangle]
pub fn sv_shcompat(mut name: *mut libc::c_char) {
    let mut current_block: u64;
    let mut v: *mut SHELL_VAR = 0 as *mut SHELL_VAR;
    let mut val: *mut libc::c_char = 0 as *mut libc::c_char;
...
#[no_mangle]
pub fn sv_childmax(mut name: *mut libc::c_char) {
    let mut tt: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut s: libc::c_int = 0;
