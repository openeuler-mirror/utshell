...
#[no_mangle]
pub fn stop_pipeline(mut async_0: libc::c_int, mut deferred: *mut COMMAND) -> libc::c_int {
    unsafe {
...
#[no_mangle]
fn bgp_add(mut pid: pid_t, mut status: libc::c_int) -> *mut pidstat {
    unsafe {
...
#[no_mangle]
fn pshash_delindex(mut psi: ps_index_t) {
    let mut ps: *mut pidstat = 0 as *mut pidstat;
    let mut bucket: *mut ps_index_t = 0 as *mut ps_index_t;
    unsafe {
        ps = &mut *(bgpids.storage).offset(psi as isize) as *mut pidstat;
...
fn bgp_delete(mut pid: pid_t) -> libc::c_int {
    unsafe {
        let mut psi: ps_index_t = 0;
...
fn bgp_search(mut pid: pid_t) -> libc::c_int {
    unsafe {
        let mut psi: ps_index_t = 0;
        let mut orig_psi: ps_index_t = 0;
        if (bgpids.storage).is_null() || bgpids.nalloc == 0 || bgpids.npid == 0 {
...
#[no_mangle]
pub fn save_proc_status(mut pid: pid_t, mut status: libc::c_int) {
    let mut set: sigset_t = __sigset_t { __val: [0; 16] };
    let mut oset: sigset_t = __sigset_t { __val: [0; 16] };
    unsafe {
        BLOCK_CHILD(&mut set, &mut oset);
...
fn procsub_free(mut p: *mut PROCESS) {
    unsafe {
...
#[no_mangle]
pub fn procsub_add(mut p: *mut PROCESS) -> *mut PROCESS {
    let mut set: sigset_t = __sigset_t { __val: [0; 16] };
    let mut oset: sigset_t = __sigset_t { __val: [0; 16] };
    unsafe {
        BLOCK_CHILD(&mut set, &mut oset);
...
#[no_mangle]
pub fn procsub_search(mut pid: pid_t) -> *mut PROCESS {
    unsafe {
        let mut p: *mut PROCESS = 0 as *mut PROCESS;
        let mut set: sigset_t = __sigset_t { __val: [0; 16] };
        let mut oset: sigset_t = __sigset_t { __val: [0; 16] };
...
#[no_mangle]
pub fn procsub_delete(mut pid: pid_t) -> *mut PROCESS {
    unsafe {
        let mut p: *mut PROCESS = 0 as *mut PROCESS;
...
#[no_mangle]
pub fn procsub_waitpid(mut pid: pid_t) -> libc::c_int {
    unsafe {
        let mut p: *mut PROCESS = 0 as *mut PROCESS;
...
fn processes_in_job(mut job: libc::c_int) -> libc::c_int {
    unsafe {
...
fn delete_old_job(mut pid: pid_t) {
    unsafe {
        let mut p: *mut PROCESS = 0 as *mut PROCESS;
...
fn compact_jobs_list(mut flags: libc::c_int) -> libc::c_int {
    unsafe {
        if js.j_jobslots == 0 || jobs_list_frozen != 0 {
...
#[no_mangle]
pub fn delete_job(mut job_index: libc::c_int, mut dflags: libc::c_int) {
    unsafe {
...
#[no_mangle]
pub fn nohup_job(mut job_index: libc::c_int) {
    unsafe {
        let mut temp: *mut JOB = 0 as *mut JOB;
...
#[no_mangle]
pub fn discard_pipeline(mut chain: *mut PROCESS) -> libc::c_int {
    unsafe {
...
fn add_process(mut name: *mut libc::c_char, mut pid: pid_t) {
    unsafe {
...
#[no_mangle]
pub fn describe_pid(mut pid: pid_t) {
    unsafe {
        let mut job: libc::c_int = 0;
        let mut set: sigset_t = __sigset_t { __val: [0; 16] };
        let mut oset: sigset_t = __sigset_t { __val: [0; 16] };
...
fn j_strsignal(mut s: libc::c_int) -> *mut libc::c_char {
    unsafe {
...
#[no_mangle]
pub fn list_stopped_jobs(mut format: libc::c_int) {
    unsafe {
        cleanup_dead_jobs();
        map_over_jobs(
...
#[no_mangle]
pub fn list_running_jobs(mut format: libc::c_int) {
    cleanup_dead_jobs();
    unsafe {
        map_over_jobs(
            ::std::mem::transmute::<Option<fn() -> libc::c_int>, Option<sh_job_map_func_t>>(Some(
...
#[no_mangle]
pub fn list_all_jobs(mut format: libc::c_int) {
    cleanup_dead_jobs();
    unsafe {
        map_over_jobs(
            ::std::mem::transmute::<Option<fn() -> libc::c_int>, Option<sh_job_map_func_t>>(Some(
...
#[no_mangle]
pub fn make_child(mut command: *mut libc::c_char, mut flags: libc::c_int) -> pid_t {
    unsafe {
...
fn find_last_proc(mut job: libc::c_int, mut block: libc::c_int) -> *mut PROCESS {
    unsafe {
        let mut p: *mut PROCESS = 0 as *mut PROCESS;
        let mut set: sigset_t = __sigset_t { __val: [0; 16] };
        let mut oset: sigset_t = __sigset_t { __val: [0; 16] };
...
fn find_last_pid(mut job: libc::c_int, mut block: libc::c_int) -> pid_t {
    unsafe {
        let mut p: *mut PROCESS = 0 as *mut PROCESS;
...
#[no_mangle]
pub fn wait_for_single_pid(mut pid: pid_t, mut flags: libc::c_int) -> libc::c_int {
    unsafe {
...
#[no_mangle]
pub fn wait_for_background_pids(mut ps: *mut procstat) {
    let mut i: libc::c_int = 0;
    let mut r: libc::c_int = 0;
    let mut any_stopped: libc::c_int = 0;
...
fn wait_sigint_handler(mut sig: libc::c_int) {
    unsafe {
...
fn process_exit_signal(mut status: WAIT) -> libc::c_int {
...
fn process_exit_status(mut status: WAIT) -> libc::c_int {
    unsafe {
...
fn job_signal_status(mut job: libc::c_int) -> WAIT {
    unsafe {
        let mut p: *mut PROCESS = 0 as *mut PROCESS;
        let mut s: WAIT = 0;
...
fn raw_job_exit_status(mut job: libc::c_int) -> WAIT {
    unsafe {
        let mut p: *mut PROCESS = 0 as *mut PROCESS;
...
#[no_mangle]
pub fn job_exit_status(mut job: libc::c_int) -> libc::c_int {
    return process_exit_status(raw_job_exit_status(job));
}
#[no_mangle]
pub fn job_exit_signal(mut job: libc::c_int) -> libc::c_int {
    return process_exit_signal(raw_job_exit_status(job));
}

#[no_mangle]
pub fn wait_for(mut pid: pid_t, mut flags: libc::c_int) -> libc::c_int {
    unsafe {
...
#[no_mangle]
pub fn wait_for_any_job(mut flags: libc::c_int, mut ps: *mut procstat) -> libc::c_int {
    unsafe {
        let mut current_block: u64;
        let mut pid: pid_t = 0;
        let mut i: libc::c_int = 0;
...
fn most_recent_job_in_state(mut job: libc::c_int, mut state: JOB_STATE) -> libc::c_int {
    unsafe {
        let mut i: libc::c_int = 0;
        let mut result: libc::c_int = 0;
        let mut set: sigset_t = __sigset_t { __val: [0; 16] };
...
fn job_last_stopped(mut job: libc::c_int) -> libc::c_int {
    return most_recent_job_in_state(job, JSTOPPED as libc::c_int);
}

fn job_last_running(mut job: libc::c_int) -> libc::c_int {
    return most_recent_job_in_state(job, JRUNNING as libc::c_int);
}

fn set_current_job(mut job: libc::c_int) {
...
fn set_job_running(mut job: libc::c_int) {
    let mut p: *mut PROCESS = 0 as *mut PROCESS;
    unsafe {
        p = (**jobs.offset(job as isize)).pipe;
        loop {
...
#[no_mangle]
pub fn start_job(mut job: libc::c_int, mut foreground: libc::c_int) -> libc::c_int {
    let mut p: *mut PROCESS = 0 as *mut PROCESS;
...
#[no_mangle]
pub fn kill_pid(mut pid: pid_t, mut sig: libc::c_int, mut group: libc::c_int) -> libc::c_int {
    unsafe {
        let mut p: *mut PROCESS = 0 as *mut PROCESS;
        let mut job: libc::c_int = 0;
        let mut result: libc::c_int = 0;
...
fn sigchld_handler(mut sig: libc::c_int) {
    let mut n: libc::c_int = 0;
...
fn waitchld(mut wpid: pid_t, mut block: libc::c_int) -> libc::c_int {
    unsafe {
...
fn set_job_status_and_cleanup(mut job: libc::c_int) -> libc::c_int {
    unsafe {
        let mut child: *mut PROCESS = 0 as *mut PROCESS;
...
fn setjstatus(mut j: libc::c_int) {
    unsafe {
        let mut i: libc::c_int = 0;
        let mut p: *mut PROCESS = 0 as *mut PROCESS;
...
#[no_mangle]
pub fn run_sigchld_trap(mut nchild: libc::c_int) {
    unsafe {
        let mut trap_command: *mut libc::c_char;
        let mut i: libc::c_int = 0;
...
#[no_mangle]
pub fn initialize_job_control(mut force: libc::c_int) -> libc::c_int {
    unsafe {
        let mut current_block: u64;
        let mut t: pid_t = 0;
...
fn set_new_line_discipline(mut tty: libc::c_int) -> libc::c_int {
    return 0 as libc::c_int;
}
...
fn sigcont_sighandler(mut sig: libc::c_int) {
    unsafe {
...
fn sigstop_sighandler(mut sig: libc::c_int) {
    unsafe {
...
#[no_mangle]
pub fn give_terminal_to(mut pgrp: pid_t, mut force: libc::c_int) -> libc::c_int {
    unsafe {
        let mut set: sigset_t = __sigset_t { __val: [0; 16] };
        let mut oset: sigset_t = __sigset_t { __val: [0; 16] };
        let mut r: libc::c_int = 0;
...
#[no_mangle]
pub fn delete_all_jobs(mut running_only: libc::c_int) {
    unsafe {
        let mut i: libc::c_int = 0;
        let mut set: sigset_t = __sigset_t { __val: [0; 16] };
        let mut oset: sigset_t = __sigset_t { __val: [0; 16] };
...
#[no_mangle]
pub fn nohup_all_jobs(mut running_only: libc::c_int) {
    unsafe {
        let mut i: libc::c_int = 0;
        let mut set: sigset_t = __sigset_t { __val: [0; 16] };
        let mut oset: sigset_t = __sigset_t { __val: [0; 16] };
...
fn mark_dead_jobs_as_notified(mut force: libc::c_int) {
    unsafe {
        let mut i: libc::c_int = 0;
...
#[no_mangle]
pub fn set_jobs_list_frozen(mut s: libc::c_int) {
    unsafe {
        jobs_list_frozen = s;
    }
}
...
#[no_mangle]
pub fn set_job_control(mut arg: libc::c_int) -> libc::c_int {
    unsafe {
        let mut old: libc::c_int = 0;
...
fn pipe_read(mut pp: *mut libc::c_int) {
...
#[no_mangle]
pub fn save_pgrp_pipe(mut p: *mut libc::c_int, mut clear: libc::c_int) {
    unsafe {
...
#[no_mangle]
pub fn restore_pgrp_pipe(mut p: *mut libc::c_int) {
    unsafe {
