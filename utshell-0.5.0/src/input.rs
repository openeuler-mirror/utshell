...
if it returns EINTR. */
#[no_mangle]
pub fn getc_with_restart(mut stream: *mut FILE) -> libc::c_int {
    unsafe {
...
#[no_mangle]
pub fn ungetc_with_restart(mut c: libc::c_int, mut stream: *mut FILE) -> libc::c_int {
    unsafe {
...
fn allocate_buffers(mut n: libc::c_int) {
...
fn copy_buffered_stream(mut bp: *mut BUFFERED_STREAM) -> *mut BUFFERED_STREAM {
    unsafe {
...
#[no_mangle]
pub fn set_bash_input_fd(mut fd: libc::c_int) -> libc::c_int {
    unsafe {
...
#[no_mangle]
pub fn fd_is_bash_input(mut fd: libc::c_int) -> libc::c_int {
    unsafe {
        if bash_input.type_0 as libc::c_uint == st_bstream as libc::c_int as libc::c_uint
            && bash_input.location.buffered_fd == fd
        {
...
#[no_mangle]
pub fn save_bash_input(mut fd: libc::c_int, mut new_fd: libc::c_int) -> libc::c_int {
    unsafe {
...
#[no_mangle]
pub fn check_bash_input(mut fd: libc::c_int) -> libc::c_int {
...
#[no_mangle]
pub fn duplicate_buffered_stream(mut fd1: libc::c_int, mut fd2: libc::c_int) -> libc::c_int {
...
#[no_mangle]
pub fn fd_to_buffered_stream(mut fd: libc::c_int) -> *mut BUFFERED_STREAM {
...
#[no_mangle]
pub fn open_buffered_stream(mut file: *mut libc::c_char) -> *mut BUFFERED_STREAM {
...
#[no_mangle]
pub fn free_buffered_stream(mut bp: *mut BUFFERED_STREAM) {
...
#[no_mangle]
pub fn close_buffered_stream(mut bp: *mut BUFFERED_STREAM) -> libc::c_int {
    let mut fd: libc::c_int = 0;
...
#[no_mangle]
pub fn close_buffered_fd(mut fd: libc::c_int) -> libc::c_int {
    unsafe {
        if fd < 0 as libc::c_int {
...
fn b_fill_buffer(mut bp: *mut BUFFERED_STREAM) -> libc::c_int {
...
fn bufstream_ungetc(mut c: libc::c_int, mut bp: *mut BUFFERED_STREAM) -> libc::c_int {
    unsafe {
...
#[no_mangle]
pub fn sync_buffered_stream(mut bfd: libc::c_int) -> libc::c_int {
    let mut bp: *mut BUFFERED_STREAM = 0 as *mut BUFFERED_STREAM;
...
#[no_mangle]
pub fn buffered_ungetchar(mut c: libc::c_int) -> libc::c_int {
    unsafe {
...
#[no_mangle]
pub fn with_input_from_buffered_stream(mut bfd: libc::c_int, mut name: *mut libc::c_char) {
