...
fn really_munge_braces(
    ...
    unsafe {
        ...
        result = libc::malloc(result_size as usize) as *mut libc::c_char;
        *result = '\0' as i32 as libc::c_char;
        ...
        while start < real_end {
            ...
            if start == end {
                ...
                tlen = gcd - gcd_zero;
                x = libc::malloc((tlen + 1 as libc::c_int) as usize) as *mut libc::c_char;
                libc::strncpy(
                    x,
        ...
        if gcd_zero == 0 as libc::c_int {
            *result.offset((libc::strlen(result) - 1 as libc::c_ulong as usize) as isize) =
...
fn _strcompare(mut s1: *mut *mut libc::c_char, mut s2: *mut *mut libc::c_char) -> libc::c_int {
    unsafe {
...
fn hack_braces_completion(mut names: *mut *mut libc::c_char) -> libc::c_int {
    let mut i: libc::c_int = 0;
        ...
        if __ctype_get_mb_cur_max() > 1 as usize && i > 2 as libc::c_int {
            qsort(
                ...
                std::mem::transmute::<Option<fn() -> libc::c_int>, Option<QSFUNC>>(Some(
                    std::mem::transmute::<
                        fn(*mut *mut libc::c_char, *mut *mut libc::c_char) -> libc::c_int,
                        fn() -> libc::c_int,
                    >(_strcompare),
                )),
            );
...
#[no_mangle]
pub fn bash_brace_completion(mut count: libc::c_int, mut ignore: libc::c_int) -> libc::c_int {
    ...
    unsafe {
        ...
        >(Some(::core::mem::transmute::<
            fn(*mut *mut libc::c_char) -> libc::c_int,
            fn() -> libc::c_int,
