...
pub fn maybe_execute_file(
    ...
    mut force_noninteractive: libc::c_int,
) -> libc::c_int {
    unsafe {
...
#[no_mangle]
pub fn fc_execute_file(mut filename: *const libc::c_char) -> libc::c_int {
    let mut flags: libc::c_int = 0;
    flags = FEVAL_ENOENTOK!() as libc::c_int
...
#[no_mangle]
pub fn source_file(mut filename: *const libc::c_char, mut sflags: libc::c_int) -> libc::c_int {
    let mut flags: libc::c_int = 0;
