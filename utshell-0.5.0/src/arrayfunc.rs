...
use crate::assoc::{
    assoc_dispose, assoc_insert, assoc_keys_to_word_list, assoc_reference, assoc_remove,
    assoc_to_assign, assoc_to_word_list,
};
...
use crate::variables::{
    ...
    make_variable_value, unbind_variable,
};
...
#[no_mangle]
pub fn convert_var_to_array(mut var: *mut SHELL_VAR) -> *mut SHELL_VAR {
    ...
    unsafe {
        ...
        (*var).dynamic_value = ::core::mem::transmute::<
            *mut libc::c_void,
            Option<sh_var_value_func_t>,
        >(0 as *mut libc::c_void);
        (*var).assign_func = ::core::mem::transmute::<
            *mut libc::c_void,
            Option<sh_var_assign_func_t>,
        >(0 as *mut libc::c_void);
...
saved as array[0]. */
#[no_mangle]
pub fn convert_var_to_assoc(mut var: *mut SHELL_VAR) -> *mut SHELL_VAR {
    let mut oldval: *mut libc::c_char = 0 as *mut libc::c_char;
...
fn assign_array_element_internal(
    mut entry: *mut SHELL_VAR,
...
pub fn expand_compound_array_assignment(
    ...
    if unsafe { *value as libc::c_int == '(' as i32 } {
        ni = 1 as libc::c_int;
...
compound assignment. */
#[no_mangle]
pub fn kvpair_assignment_p(mut l: *mut WORD_LIST) -> libc::c_int {
    unsafe {
        return (!l.is_null()
...
#[no_mangle]
pub fn expand_and_quote_kvpair_word(mut w: *mut libc::c_char) -> *mut libc::c_char {
                ...
                && *w.offset(0 as libc::c_int as isize) as libc::c_int == '[' as i32
            {
                ...
                if *w.offset(len as isize) as libc::c_int != ']' as i32
                    || *w.offset((len + 1 as libc::c_int) as isize) as libc::c_int != '=' as i32
                        && (*w.offset((len + 1 as libc::c_int) as isize) as libc::c_int
                            != '+' as i32
...
fn quote_assign(mut string: *const libc::c_char) -> *mut libc::c_char {
    ...
    unsafe {
        ...
        *w.offset(ind as isize) = RBRACK!() as i32 as libc::c_char;
        ...
        nword = libc::malloc((wlen * 4 as libc::c_int + 5 as libc::c_int) as usize)
            as *mut libc::c_char; /* wlen*4 is max single quoted length */
...
pub fn expand_and_quote_assoc_word(
    ...
    unsafe {
        ...
        *w.offset(ind as isize) = '\0' as i32 as libc::c_char;
        t = expand_assignment_string_to_string(
            w.offset(1 as libc::c_int as isize),
            0 as libc::c_int,
        );
        *w.offset(ind as isize) = RBRACK!() as i32 as libc::c_char;
        ...
        *nword.offset(fresh19 as isize) = *w.offset(fresh18 as isize);
        ...
        nword = libc::realloc(
            ...
            ((wlen + 5 as libc::c_int) as libc::c_ulong)
                .wrapping_add(STRLEN!(value) as libc::c_ulong) as usize,
        ) as *mut libc::c_char;
        libc::strcpy(nword.offset(i as isize), value);
...
#[no_mangle]
pub fn quote_compound_array_list(mut list: *mut WORD_LIST, mut type_0: libc::c_int) {
    let mut t: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut l: *mut WORD_LIST = 0 as *mut WORD_LIST;
...
fn quote_array_assignment_chars(mut list: *mut WORD_LIST) {
    let mut nword: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut l: *mut WORD_LIST = 0 as *mut WORD_LIST;
...
#[no_mangle]
pub fn print_array_assignment(mut var: *mut SHELL_VAR, mut quoted: libc::c_int) {
...
#[no_mangle]
pub fn print_assoc_assignment(mut var: *mut SHELL_VAR, mut quoted: libc::c_int) {
    let mut vstr: *mut libc::c_char = 0 as *mut libc::c_char;
    unsafe {
...
#[no_mangle]
pub fn valid_array_reference(mut name: *const libc::c_char, mut flags: libc::c_int) -> libc::c_int {
    let mut t: *mut libc::c_char = 0 as *mut libc::c_char;
    ...
    if !t.is_null() {
        unsafe {
            ...
            *t = '[' as i32 as libc::c_char;
            ...
            {
                len = (libc::strlen(t)).wrapping_sub(1 as libc::c_int as libc::c_ulong as usize)
                    as libc::c_int;
            } else if isassoc != 0 {
