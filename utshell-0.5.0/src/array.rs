...
#[no_mangle]
pub fn array_flush(mut a: *mut ARRAY) {
...
#[no_mangle]
pub fn array_dispose(mut a: *mut ARRAY) {
    if a.is_null() {
        return;
    }
    array_flush(a);
...
#[no_mangle]
pub fn array_copy(mut a: *mut ARRAY) -> *mut ARRAY {
...
#[no_mangle]
pub fn array_unshift_element(mut a: *mut ARRAY) -> *mut ARRAY_ELEMENT {
    return array_shift(a, 1 as libc::c_int, 0 as libc::c_int);
}
#[no_mangle]
pub fn array_shift_element(mut a: *mut ARRAY, mut v: *mut libc::c_char) -> libc::c_int {
    return array_rshift(a, 1 as libc::c_int, v);
}
#[no_mangle]
pub fn array_quote(mut array: *mut ARRAY) -> *mut ARRAY {
...
#[no_mangle]
pub fn array_quote_escapes(mut array: *mut ARRAY) -> *mut ARRAY {
    let mut a: *mut ARRAY_ELEMENT = 0 as *mut ARRAY_ELEMENT;
    let mut t: *mut libc::c_char = 0 as *mut libc::c_char;
    unsafe {
        if array.is_null() || array_head!(array).is_null() || array_empty!(array) {
...
#[no_mangle]
pub fn array_dequote(mut array: *mut ARRAY) -> *mut ARRAY {
    let mut a: *mut ARRAY_ELEMENT = 0 as *mut ARRAY_ELEMENT;
    let mut t: *mut libc::c_char = 0 as *mut libc::c_char;
    unsafe {
        if array.is_null() || array_head!(array).is_null() || array_empty!(array) {
...
#[no_mangle]
pub fn array_dequote_escapes(mut array: *mut ARRAY) -> *mut ARRAY {
    let mut a: *mut ARRAY_ELEMENT = 0 as *mut ARRAY_ELEMENT;
    let mut t: *mut libc::c_char = 0 as *mut libc::c_char;
    unsafe {
        if array.is_null() || array_head!(array).is_null() || array_empty!(array) {
...
#[no_mangle]
pub fn array_remove_quoted_nulls(mut array: *mut ARRAY) -> *mut ARRAY {
    let mut a: *mut ARRAY_ELEMENT = 0 as *mut ARRAY_ELEMENT;
    unsafe {
        if array.is_null() || array_head!(array).is_null() || array_empty!(array) {
            return 0 as *mut libc::c_void as *mut ARRAY;
...
#[no_mangle]
pub fn array_dispose_element(mut ae: *mut ARRAY_ELEMENT) {
    unsafe {
        if !ae.is_null() {
            if !((*ae).value).is_null() {
...
#[no_mangle]
pub fn array_insert(mut a: *mut ARRAY, mut i: arrayind_t, mut v: *mut libc::c_char) -> libc::c_int {
    let mut new: *mut ARRAY_ELEMENT = 0 as *mut ARRAY_ELEMENT;
    let mut ae: *mut ARRAY_ELEMENT = 0 as *mut ARRAY_ELEMENT;
...
#[no_mangle]
pub fn array_remove(mut a: *mut ARRAY, mut i: arrayind_t) -> *mut ARRAY_ELEMENT {
    let mut ae: *mut ARRAY_ELEMENT = 0 as *mut ARRAY_ELEMENT;
    let mut start: *mut ARRAY_ELEMENT = 0 as *mut ARRAY_ELEMENT;
    let mut startind: arrayind_t = 0;
    let mut direction: libc::c_int = 0;
...
#[no_mangle]
pub fn array_reference(mut a: *mut ARRAY, mut i: arrayind_t) -> *mut libc::c_char {
    let mut ae: *mut ARRAY_ELEMENT = 0 as *mut ARRAY_ELEMENT;
    let mut start: *mut ARRAY_ELEMENT = 0 as *mut ARRAY_ELEMENT;
    let mut startind: arrayind_t = 0;
    let mut direction: libc::c_int = 0;
...
#[no_mangle]
pub fn array_to_word_list(mut a: *mut ARRAY) -> *mut WORD_LIST {
...
#[no_mangle]
pub fn array_assign_list(mut array: *mut ARRAY, mut list: *mut WORD_LIST) -> *mut ARRAY {
...
#[no_mangle]
pub fn array_from_word_list(mut list: *mut WORD_LIST) -> *mut ARRAY {
    let mut a: *mut ARRAY = 0 as *mut ARRAY;
    if list.is_null() {
        return 0 as *mut libc::c_void as *mut ARRAY;
    }
...
#[no_mangle]
pub fn array_keys_to_word_list(mut a: *mut ARRAY) -> *mut WORD_LIST {
    let mut list: *mut WORD_LIST = 0 as *mut WORD_LIST;
    let mut ae: *mut ARRAY_ELEMENT = 0 as *mut ARRAY_ELEMENT;
    let mut t: *mut libc::c_char = 0 as *mut libc::c_char;
    unsafe {
...
#[no_mangle]
pub fn array_to_argv(mut a: *mut ARRAY, mut countp: *mut libc::c_int) -> *mut *mut libc::c_char {
...
#[no_mangle]
pub fn array_to_kvpair(mut a: *mut ARRAY, mut quoted: libc::c_int) -> *mut libc::c_char {
    let mut result: *mut libc::c_char = 0 as *mut libc::c_char;
...
#[no_mangle]
pub fn array_to_assign(mut a: *mut ARRAY, mut quoted: libc::c_int) -> *mut libc::c_char {
    let mut result: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut valstr: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut is: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut indstr: [libc::c_char; 22] = [0; 22];
