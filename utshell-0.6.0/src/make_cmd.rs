...
#[no_mangle]
pub fn make_bare_word(mut string: *const libc::c_char) -> *mut WordDesc {
    let mut temp: *mut WordDesc = 0 as *mut WordDesc;
...
#[no_mangle]
pub fn make_word_flags(mut w: *mut WordDesc, mut string: *const libc::c_char) -> *mut WordDesc {
...
#[no_mangle]
pub fn make_word(mut string: *const libc::c_char) -> *mut WordDesc {
    unsafe {
        let mut temp: *mut WordDesc = 0 as *mut WordDesc;
...
#[no_mangle]
pub fn make_word_from_token(mut token: libc::c_int) -> *mut WordDesc {
...
#[no_mangle]
pub fn make_word_list(mut word: *mut WordDesc, mut wlink: *mut WordList) -> *mut WordList {
...
#[no_mangle]
pub fn make_command(mut type_0: command_type, mut pointer: *mut SIMPLE_COM) -> *mut COMMAND {
...
fn make_arith_for_expr(mut s: *mut libc::c_char) -> *mut WordList {
...
#[no_mangle]
pub fn make_group_command(mut command: *mut COMMAND) -> *mut COMMAND {
    unsafe {
...
#[no_mangle]
pub fn make_while_command(mut test: *mut COMMAND, mut action: *mut COMMAND) -> *mut COMMAND {
    return make_until_or_while(command_type_cm_while, test, action);
}

#[no_mangle]
pub fn make_until_command(mut test: *mut COMMAND, mut action: *mut COMMAND) -> *mut COMMAND {
    return make_until_or_while(command_type_cm_until, test, action);
}

#[no_mangle]
pub fn make_arith_command(mut exp: *mut WordList) -> *mut COMMAND {
...
#[no_mangle]
pub fn make_cond_command(mut cond_node: *mut COND_COM) -> *mut COMMAND {
    let mut command: *mut COMMAND = 0 as *mut COMMAND;
    unsafe {
        command = malloc(std::mem::size_of::<COMMAND>() as usize) as *mut COMMAND;
...
#[no_mangle]
pub fn make_simple_command(mut element: ELEMENT, mut command: *mut COMMAND) -> *mut COMMAND {
    unsafe {
        if command.is_null() {
...
#[no_mangle]
pub fn make_here_document(mut temp: *mut REDIRECT, mut lineno: libc::c_int) {
...
#[no_mangle]
pub fn make_subshell_command(mut command: *mut COMMAND) -> *mut COMMAND {
    unsafe {
...
#[no_mangle]
pub fn make_coproc_command(mut name: *mut libc::c_char, mut command: *mut COMMAND) -> *mut COMMAND {
...
fn output_requirement(mut deptype: *const libc::c_char, mut filename: *mut libc::c_char) {
    unsafe {
...
#[no_mangle]
pub fn clean_simple_command(mut command: *mut COMMAND) -> *mut COMMAND {
    unsafe {
