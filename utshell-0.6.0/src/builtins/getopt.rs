...
#[no_mangle]
pub fn sh_getopt_restore_state(mut argv: *mut *mut libc::c_char) {
    unsafe {
        if !nextchar.is_null() {
...
pub fn sh_getopt_alloc_istate() -> *mut sh_getopt_state_t {
    unsafe {
        ...
        ret =
            malloc((::std::mem::size_of::<sh_getopt_state_t>() as usize)) as *mut sh_getopt_state_t;
        return ret;
    }
}
#[no_mangle]
pub fn sh_getopt_dispose_istate(mut gs: *mut sh_getopt_state_t) {
    unsafe {
...
#[no_mangle]
pub fn sh_getopt_restore_istate(mut state: *mut sh_getopt_state_t) {
    unsafe {
