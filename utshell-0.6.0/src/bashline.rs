...
#[no_mangle]
pub fn posix_readline_initialize(mut on_or_off: libc::c_int) {
...
#[no_mangle]
pub fn enable_hostname_completion(mut on_or_off: libc::c_int) -> libc::c_int {
...
#[no_mangle]
pub fn bash_re_edit(mut line: *mut libc::c_char) -> libc::c_int {
    unsafe {
...
fn display_shell_version(mut count: libc::c_int, mut c: libc::c_int) -> libc::c_int {
    unsafe {
        rl_crlf();
...
fn add_host_name(mut name: *mut libc::c_char) {
    unsafe {
...
fn snarf_hosts_from_file(mut filename: *mut libc::c_char) {
...
fn hostnames_matching(mut text: *mut libc::c_char) -> *mut *mut libc::c_char {
    let mut i: libc::c_int = 0;
...
fn edit_and_execute_command(
    ...
    mut c: libc::c_int,
    mut editing_mode: libc::c_int,
    mut edit_command: *mut libc::c_char,
) -> libc::c_int {
...
fn vi_edit_and_execute_command(mut count: libc::c_int, mut c: libc::c_int) -> libc::c_int {
...
fn emacs_edit_and_execute_command(mut count: libc::c_int, mut c: libc::c_int) -> libc::c_int {
    return edit_and_execute_command(count, c, EMACS_EDITING_MODE!(), EMACS_EDIT_COMMAND!());
}

fn posix_edit_macros(mut count: libc::c_int, mut key: libc::c_int) -> libc::c_int {
...
fn bash_forward_shellword(mut count: libc::c_int, mut key: libc::c_int) -> libc::c_int {
...
fn bash_backward_shellword(mut count: libc::c_int, mut key: libc::c_int) -> libc::c_int {
    let mut slen: size_t = 0;
    let mut c: libc::c_int = 0;
    let mut p: libc::c_int = 0;
...
fn bash_kill_shellword(mut count: libc::c_int, mut key: libc::c_int) -> libc::c_int {
    let mut p: libc::c_int = 0;
...
fn bash_backward_kill_shellword(mut count: libc::c_int, mut key: libc::c_int) -> libc::c_int {
    let mut p: libc::c_int = 0;
...
fn bash_transpose_shellwords(mut count: libc::c_int, mut key: libc::c_int) -> libc::c_int {
    ...
    unsafe {
        let mut orig_point: libc::c_int = rl_point;
...
fn check_redir(mut ti: libc::c_int) -> libc::c_int {
...
fn find_cmd_start(mut start: libc::c_int) -> libc::c_int {
...
fn find_cmd_end(mut end: libc::c_int) -> libc::c_int {
...
fn prog_complete_return(
    mut text: *const libc::c_char,
    mut matchnum: libc::c_int,
) -> *mut libc::c_char {
...
fn invalid_completion(mut text: *const libc::c_char, mut ind: libc::c_int) -> libc::c_int {
...
fn bash_command_name_stat_hook(mut name: *mut *mut libc::c_char) -> libc::c_int {
...
pub fn command_word_completion_function(
    mut hint_text: *const libc::c_char,
                    ...
                    5440753863019323004 => {
                        while local_index < num_shell_builtins {
                                    ...
                                    == 0 as libc::c_int)
                            {
                                ...
                                {
                                    let mut i: libc::c_int = local_index;
                                    local_index = local_index + 1;
...
fn history_expand_line_internal(mut line: *mut libc::c_char) -> *mut libc::c_char {
...
fn maybe_make_readline_line(mut new_line: *mut libc::c_char) {
    unsafe {
...
fn set_up_new_line(mut new_line: *mut libc::c_char) {
...
fn alias_expand_line(mut count: libc::c_int, mut ignore: libc::c_int) -> libc::c_int {
    let mut new_line: *mut libc::c_char = 0 as *mut libc::c_char;
...
fn history_expand_line(mut count: libc::c_int, mut ignore: libc::c_int) -> libc::c_int {
    let mut new_line: *mut libc::c_char = 0 as *mut libc::c_char;
...
fn tcsh_magic_space(mut count: libc::c_int, mut ignore: libc::c_int) -> libc::c_int {
...
fn history_and_alias_expand_line(mut count: libc::c_int, mut ignore: libc::c_int) -> libc::c_int {
    let mut new_line: *mut libc::c_char = 0 as *mut libc::c_char;
    unsafe {
...
fn shell_expand_line(mut count: libc::c_int, mut ignore: libc::c_int) -> libc::c_int {
    let mut new_line: *mut libc::c_char = 0 as *mut libc::c_char;
    ...
    unsafe {
        ...
        if !new_line.is_null() {
            let mut old_point: libc::c_int = rl_point;
            let mut at_end: libc::c_int = (rl_point == rl_end) as libc::c_int;
    ...
    unsafe {
        if (*names.offset(1 as isize)).is_null() {
            if force_fignore != 0 {
                ...
                //可能会出现问题
                {
                    libc::free(*names.offset(0 as libc::c_int as isize) as *mut c_void);
        ...
        *newnames.offset(0 as isize) = *names.offset(0 as isize);
        ...
        while !(*names.offset(idx as isize)).is_null() {
            if (Some(name_func.expect("non-null function pointer")))
                .expect("non-null function pointer")(*names.offset(idx as isize))
                != 0
            {
                ...
                *(*oldnames).offset(oidx as isize) = *(*names).offset(idx as isize);
                ...
                libc::free(*names.offset(idx as isize) as *mut c_void);
            }
            idx += 1;
        }
...
fn name_is_acceptable(mut name: *const libc::c_char) -> libc::c_int {
...
fn filename_completion_ignore(mut names: *mut *mut libc::c_char) -> libc::c_int {
    unsafe {
...
fn test_for_directory(mut name: *const libc::c_char) -> libc::c_int {
...
fn test_for_canon_directory(mut name: *const libc::c_char) -> libc::c_int {
    let mut fn_0: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut r: libc::c_int = 0;
    unsafe {
...
fn bash_ignore_filenames(mut names: *mut *mut libc::c_char) -> libc::c_int {
    _ignore_completion_names(names, Some(test_for_directory));
    return 0;
}

fn bash_progcomp_ignore_filenames(mut names: *mut *mut libc::c_char) -> libc::c_int {
    _ignore_completion_names(names, Some(test_for_canon_directory));
    return 0;
}

fn return_zero(mut name: *const libc::c_char) -> libc::c_int {
    return 0;
}

fn bash_ignore_everything(mut names: *mut *mut libc::c_char) -> libc::c_int {
...
fn restore_tilde(
    ...
    mut directory_part: *mut libc::c_char,
) -> *mut libc::c_char {
...
fn bash_directory_expansion(mut dirname: *mut *mut libc::c_char) {
...
fn bash_filename_rewrite_hook(
    mut fname: *mut libc::c_char,
    mut fnlen: libc::c_int,
) -> *mut libc::c_char {
...
fn restore_directory_hook(mut hookf: rl_icppfunc_t) {
    unsafe {
        if dircomplete_expand != 0 {
...
fn bash_filename_stat_hook(mut dirname: *mut *mut libc::c_char) -> libc::c_int {
...
fn bash_directory_completion_hook(mut dirname: *mut *mut libc::c_char) -> libc::c_int {
    let mut local_dirname: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut new_dirname: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut t: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut return_value: libc::c_int = 0;
...
fn dynamic_complete_history(mut count: libc::c_int, mut key: libc::c_int) -> libc::c_int {
    let mut r: libc::c_int = 0;
...
fn bash_dabbrev_expand(mut count: libc::c_int, mut key: libc::c_int) -> libc::c_int {
    let mut r: libc::c_int = 0;
...
fn bash_complete_username(mut ignore: libc::c_int, mut ignore2: libc::c_int) -> libc::c_int {
    unsafe {
...
fn bash_possible_username_completions(
    mut ignore: libc::c_int,
    mut ignore2: libc::c_int,
) -> libc::c_int {
    return bash_complete_username_internal('?' as i32);
}

fn bash_complete_username_internal(mut what_to_do: libc::c_int) -> libc::c_int {
...
fn bash_complete_filename(mut ignore: libc::c_int, mut ignore2: libc::c_int) -> libc::c_int {
    unsafe {
...
fn bash_possible_filename_completions(
    mut ignore: libc::c_int,
    mut ignore2: libc::c_int,
) -> libc::c_int {
...
fn bash_complete_filename_internal(mut what_to_do: libc::c_int) -> libc::c_int {
    let mut orig_func: Option<rl_compentry_func_t> = None;
    let mut orig_attempt_func: Option<rl_completion_func_t> = None;
...
fn bash_complete_hostname(mut ignore: libc::c_int, mut ignore2: libc::c_int) -> libc::c_int {
    unsafe {
...
fn bash_possible_hostname_completions(
    mut ignore: libc::c_int,
    mut ignore2: libc::c_int,
) -> libc::c_int {
...
fn bash_complete_variable(mut ignore: libc::c_int, mut ignore2: libc::c_int) -> libc::c_int {
    unsafe {
...
fn bash_possible_variable_completions(
    mut ignore: libc::c_int,
    mut ignore2: libc::c_int,
) -> libc::c_int {
...
fn bash_complete_command(mut ignore: libc::c_int, mut ignore2: libc::c_int) -> libc::c_int {
    unsafe {
...
fn bash_possible_command_completions(
    mut ignore: libc::c_int,
    mut ignore2: libc::c_int,
) -> libc::c_int {
...
fn bash_complete_hostname_internal(mut what_to_do: libc::c_int) -> libc::c_int {
    return bash_specific_completion(what_to_do, Some(hostname_completion_function));
}

fn bash_complete_variable_internal(mut what_to_do: libc::c_int) -> libc::c_int {
    return bash_specific_completion(what_to_do, Some(variable_completion_function));
}

fn bash_complete_command_internal(mut what_to_do: libc::c_int) -> libc::c_int {
    return bash_specific_completion(what_to_do, Some(command_word_completion_function));
}

fn completion_glob_pattern(mut string: *mut libc::c_char) -> libc::c_int {
    unsafe {
...
fn glob_complete_word(mut text: *const libc::c_char, mut state: libc::c_int) -> *mut libc::c_char {
    static mut matches: *mut *mut libc::c_char =
        0 as *const c_void as *mut c_void as *mut *mut libc::c_char;
    static mut ind: libc::c_int = 0;
...
fn bash_glob_completion_internal(mut what_to_do: libc::c_int) -> libc::c_int {
...
fn bash_glob_complete_word(mut count: libc::c_int, mut key: libc::c_int) -> libc::c_int {
    let mut r: libc::c_int = 0;
...
fn bash_glob_expand_word(mut count: libc::c_int, mut key: libc::c_int) -> libc::c_int {
    return bash_glob_completion_internal('*' as i32);
}

fn bash_glob_list_expansions(mut count: libc::c_int, mut key: libc::c_int) -> libc::c_int {
    return bash_glob_completion_internal('?' as i32);
}

fn bash_specific_completion(
    mut what_to_do: libc::c_int,
    mut generator: Option<rl_compentry_func_t>,
) -> libc::c_int {
    let mut orig_func: Option<rl_compentry_func_t> = None;
    let mut orig_attempt_func: Option<rl_completion_func_t> = None;
    let mut orig_ignore_func: Option<rl_compignore_func_t> = None;
...
fn bash_vi_complete(mut count: libc::c_int, mut key: libc::c_int) -> libc::c_int {
    let mut p: libc::c_int = 0;
    let mut r: libc::c_int = 0;
    let mut t: *mut libc::c_char = 0 as *mut libc::c_char;
    unsafe {
...
fn bash_dequote_filename(
    mut text: *mut libc::c_char,
    mut quote_char: libc::c_int,
) -> *mut libc::c_char {
    let mut ret: *mut libc::c_char = 0 as *mut libc::c_char;
...
fn quote_word_break_chars(mut text: *mut libc::c_char) -> *mut libc::c_char {
    let mut ret: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut r: *mut libc::c_char = 0 as *mut libc::c_char;
...
fn set_filename_bstab(mut string: *const libc::c_char) {
    unsafe {
...
fn readline_get_char_offset(mut ind: libc::c_int) -> libc::c_int {
    let mut r: libc::c_int = 0;
...
fn readline_set_char_offset(mut ind: libc::c_int, mut varp: *mut libc::c_int) {
    let mut i: libc::c_int = 0;
    i = ind;
    unsafe {
...
#[no_mangle]
pub fn bash_execute_unix_command(mut count: libc::c_int, mut key: libc::c_int) -> libc::c_int {
...
fn get_cmd_xmap_from_keymap(mut kmap: Keymap) -> Keymap {
    unsafe {
...
#[no_mangle]
pub fn bind_keyseq_to_unix_command(mut line: *mut libc::c_char) -> libc::c_int {
...
#[no_mangle]
pub fn unbind_unix_command(mut kseq: *mut libc::c_char) -> libc::c_int {
    let mut cmd_xmap: Keymap = 0 as *mut KEYMAP_ENTRY;
    unsafe {
        cmd_xmap = get_cmd_xmap_from_keymap(rl_get_keymap());
...
#[no_mangle]
pub fn bash_directory_completion_matches(mut text: *const libc::c_char) -> *mut *mut libc::c_char {
...
#[no_mangle]
pub fn bash_dequote_text(mut text: *const libc::c_char) -> *mut libc::c_char {
