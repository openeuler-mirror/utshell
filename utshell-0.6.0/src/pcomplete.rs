...
#[no_mangle]
pub fn set_itemlist_dirty(mut it: *mut ITEMLIST) {
    unsafe {
        (*it).flags |= LIST_DIRTY as libc::c_int;
    }
}
#[no_mangle]
pub fn initialize_itemlist(mut itp: *mut ITEMLIST) {
    unsafe {
...
#[no_mangle]
pub fn clean_itemlist(mut itp: *mut ITEMLIST) {
...
#[no_mangle]
fn shouldexp_filterpat(mut s: *mut libc::c_char) -> libc::c_int {
...
pub fn filter_stringlist(
    mut sl: *mut STRINGLIST,
    mut filterpat: *mut libc::c_char,
    mut text: *const libc::c_char,
) -> *mut STRINGLIST {
    unsafe {
...
#[no_mangle]
pub fn completions_to_stringlist(mut matches: *mut *mut libc::c_char) -> *mut STRINGLIST {
    unsafe {
        let mut sl: *mut STRINGLIST = 0 as *mut STRINGLIST;
...
#[no_mangle]
fn it_init_aliases(mut itp: *mut ITEMLIST) -> libc::c_int {
...
#[no_mangle]
fn init_itemlist_from_varlist(mut itp: *mut ITEMLIST, mut svfunc: Option<SVFUNC>) {
...
#[no_mangle]
fn it_init_arrayvars(mut itp: *mut ITEMLIST) -> libc::c_int {
    unsafe {
...
#[no_mangle]
fn it_init_bindings(mut itp: *mut ITEMLIST) -> libc::c_int {
...
#[no_mangle]
fn it_init_builtins(mut itp: *mut ITEMLIST) -> libc::c_int {
    let mut sl: *mut STRINGLIST = 0 as *mut STRINGLIST;
    let mut i: libc::c_int = 0;
    let mut n: libc::c_int = 0;
    unsafe {
...
#[no_mangle]
fn it_init_enabled(mut itp: *mut ITEMLIST) -> libc::c_int {
    let mut sl: *mut STRINGLIST = 0 as *mut STRINGLIST;
    let mut i: libc::c_int = 0;
    let mut n: libc::c_int = 0;
    unsafe {
...
#[no_mangle]
fn it_init_disabled(mut itp: *mut ITEMLIST) -> libc::c_int {
    let mut sl: *mut STRINGLIST = 0 as *mut STRINGLIST;
    let mut i: libc::c_int = 0;
    let mut n: libc::c_int = 0;
    unsafe {
...
#[no_mangle]
fn it_init_exported(mut itp: *mut ITEMLIST) -> libc::c_int {
    unsafe {
        init_itemlist_from_varlist(
            itp,
            ::std::mem::transmute::<Option<fn() -> *mut *mut SHELL_VAR>, Option<SVFUNC>>(Some(
...
#[no_mangle]
fn it_init_functions(mut itp: *mut ITEMLIST) -> libc::c_int {
    unsafe {
        init_itemlist_from_varlist(
            itp,
            ::std::mem::transmute::<Option<fn() -> *mut *mut SHELL_VAR>, Option<SVFUNC>>(Some(
...
#[no_mangle]
fn it_init_helptopics(mut itp: *mut ITEMLIST) -> libc::c_int {
    let mut sl: *mut STRINGLIST = 0 as *mut STRINGLIST;
    let mut i: libc::c_int = 0;
    let mut n: libc::c_int = 0;
    unsafe {
...
#[no_mangle]
fn it_init_hostnames(mut itp: *mut ITEMLIST) -> libc::c_int {
    let mut sl: *mut STRINGLIST = 0 as *mut STRINGLIST;
    unsafe {
        sl = strlist_create(0 as libc::c_int);
...
#[no_mangle]
fn it_init_joblist(mut itp: *mut ITEMLIST, mut jstate: libc::c_int) -> libc::c_int {
    let mut sl: *mut STRINGLIST = 0 as *mut STRINGLIST;
    let mut i: libc::c_int = 0;
...
#[no_mangle]
fn it_init_jobs(mut itp: *mut ITEMLIST) -> libc::c_int {
    return it_init_joblist(itp, -(1 as libc::c_int));
}
#[no_mangle]
fn it_init_running(mut itp: *mut ITEMLIST) -> libc::c_int {
    return it_init_joblist(itp, 0 as libc::c_int);
}
#[no_mangle]
fn it_init_stopped(mut itp: *mut ITEMLIST) -> libc::c_int {
    return it_init_joblist(itp, 1 as libc::c_int);
}
#[no_mangle]
fn it_init_keywords(mut itp: *mut ITEMLIST) -> libc::c_int {
    let mut sl: *mut STRINGLIST = 0 as *mut STRINGLIST;
    let mut i: libc::c_int = 0;
    let mut n: libc::c_int = 0;
    n = 0 as libc::c_int;
...
#[no_mangle]
fn it_init_signals(mut itp: *mut ITEMLIST) -> libc::c_int {
    let mut sl: *mut STRINGLIST = 0 as *mut STRINGLIST;
    unsafe {
        sl = strlist_create(0 as libc::c_int);
...
#[no_mangle]
fn it_init_variables(mut itp: *mut ITEMLIST) -> libc::c_int {
    unsafe {
        init_itemlist_from_varlist(
            itp,
            ::std::mem::transmute::<Option<fn() -> *mut *mut SHELL_VAR>, Option<SVFUNC>>(Some(
...
#[no_mangle]
fn it_init_setopts(mut itp: *mut ITEMLIST) -> libc::c_int {
    let mut sl: *mut STRINGLIST = 0 as *mut STRINGLIST;
    unsafe {
        sl = strlist_create(0 as libc::c_int);
...
#[no_mangle]
fn it_init_shopts(mut itp: *mut ITEMLIST) -> libc::c_int {
    let mut sl: *mut STRINGLIST = 0 as *mut STRINGLIST;
    unsafe {
        sl = strlist_create(0 as libc::c_int);
...
#[no_mangle]
fn gen_matches_from_itemlist(
    mut itp: *mut ITEMLIST,
    mut text: *const libc::c_char,
) -> *mut STRINGLIST {
    let mut ret: *mut STRINGLIST = 0 as *mut STRINGLIST;
    let mut sl: *mut STRINGLIST = 0 as *mut STRINGLIST;
...
#[no_mangle]
fn gen_action_completions(mut cs: *mut COMPSPEC, mut text: *const libc::c_char) -> *mut STRINGLIST {
    unsafe {
        let mut ret: *mut STRINGLIST = 0 as *mut STRINGLIST;
...
#[no_mangle]
fn gen_wordlist_matches(mut cs: *mut COMPSPEC, mut text: *const libc::c_char) -> *mut STRINGLIST {
    unsafe {
...
#[no_mangle]
fn bind_comp_words(mut lwords: *mut WORD_LIST) -> *mut SHELL_VAR {
    unsafe {
...
fn bind_compfunc_variables(
    ...
    mut ind: libc::c_int,
    mut lwords: *mut WORD_LIST,
    mut cw: libc::c_int,
    mut exported: libc::c_int,
) {
...
#[no_mangle]
fn unbind_compfunc_variables(mut exported: libc::c_int) {
...
#[no_mangle]
pub fn pcomp_set_readline_variables(mut flags: libc::c_int, mut nval: libc::c_int) {
    unsafe {
...
fn gen_progcomp_completions(
    mut ocmd: *const libc::c_char,
    mut cmd: *const libc::c_char,
    mut word: *const libc::c_char,
    mut start: libc::c_int,
    mut end: libc::c_int,
    mut foundp: *mut libc::c_int,
    mut retryp: *mut libc::c_int,
    mut lastcs: *mut *mut COMPSPEC,
) -> *mut STRINGLIST {
    unsafe {
