...
#[inline]
fn ere_char(mut c: libc::c_int) -> libc::c_int {
...
#[no_mangle]
pub fn glob_char_p(mut s: *const libc::c_char) -> libc::c_int {
    unsafe {
...
#[no_mangle]
pub fn quote_globbing_chars(mut string: *const libc::c_char) -> *mut libc::c_char {
    unsafe {
...
pub fn shell_glob_filename(
    ...
    unsafe {
        ...
        let mut quoted_pattern: libc::c_int = 0;
...
#[no_mangle]
pub fn setup_glob_ignore(mut name: *mut libc::c_char) {
...
fn glob_name_is_acceptable(mut name: *const libc::c_char) -> libc::c_int {
...
#[no_mangle]
pub fn ignore_glob_matches(mut names: *mut *mut libc::c_char) {
    unsafe {
...
fn split_ignorespec(mut s: *mut libc::c_char, mut ip: *mut libc::c_int) -> *mut libc::c_char {
    let mut t: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut n: libc::c_int = 0;
    let mut i: libc::c_int = 0;
    if s.is_null() {
...
#[no_mangle]
pub fn setup_ignore_patterns(mut ivp: *mut ignorevar) {
