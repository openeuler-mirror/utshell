...
#[no_mangle]
pub fn assoc_dispose(mut hash: *mut HASH_TABLE) {
    unsafe {
        if !hash.is_null() {
...
#[no_mangle]
pub fn assoc_flush(mut hash: *mut HASH_TABLE) {
    hash_flush(hash, None);
}
...
#[no_mangle]
pub fn assoc_remove(mut hash: *mut HASH_TABLE, mut string: *mut libc::c_char) {
    let mut b: *mut BUCKET_CONTENTS = 0 as *mut BUCKET_CONTENTS;
...
#[no_mangle]
pub fn assoc_quote(mut h: *mut HASH_TABLE) -> *mut HASH_TABLE {
...
#[no_mangle]
pub fn assoc_quote_escapes(mut h: *mut HASH_TABLE) -> *mut HASH_TABLE {
    let mut i: libc::c_int = 0;
    let mut tlist: *mut BUCKET_CONTENTS = 0 as *mut BUCKET_CONTENTS;
    let mut t: *mut libc::c_char = 0 as *mut libc::c_char;
    unsafe {
...
#[no_mangle]
pub fn assoc_dequote(mut h: *mut HASH_TABLE) -> *mut HASH_TABLE {
    let mut i: libc::c_int = 0;
    let mut tlist: *mut BUCKET_CONTENTS = 0 as *mut BUCKET_CONTENTS;
    let mut t: *mut libc::c_char = 0 as *mut libc::c_char;
    unsafe {
...
#[no_mangle]
pub fn assoc_dequote_escapes(mut h: *mut HASH_TABLE) -> *mut HASH_TABLE {
    let mut i: libc::c_int = 0;
    let mut tlist: *mut BUCKET_CONTENTS = 0 as *mut BUCKET_CONTENTS;
    let mut t: *mut libc::c_char = 0 as *mut libc::c_char;
    unsafe {
...
#[no_mangle]
pub fn assoc_remove_quoted_nulls(mut h: *mut HASH_TABLE) -> *mut HASH_TABLE {
    let mut i: libc::c_int = 0;
    let mut tlist: *mut BUCKET_CONTENTS = 0 as *mut BUCKET_CONTENTS;
    let mut t: *mut libc::c_char = 0 as *mut libc::c_char;
    unsafe {
...
#[no_mangle]
pub fn assoc_to_kvpair(mut hash: *mut HASH_TABLE, mut quoted: libc::c_int) -> *mut libc::c_char {
    let mut ret: *mut libc::c_char = 0 as *mut libc::c_char;
...
#[no_mangle]
pub fn assoc_to_assign(mut hash: *mut HASH_TABLE, mut quoted: libc::c_int) -> *mut libc::c_char {
    let mut ret: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut istr: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut vstr: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut i: libc::c_int = 0;
...
fn assoc_to_word_list_internal(mut h: *mut HASH_TABLE, mut t: libc::c_int) -> *mut WORD_LIST {
...
#[no_mangle]
pub fn assoc_to_word_list(mut h: *mut HASH_TABLE) -> *mut WORD_LIST {
    return assoc_to_word_list_internal(h, 0 as libc::c_int);
}

#[no_mangle]
pub fn assoc_keys_to_word_list(mut h: *mut HASH_TABLE) -> *mut WORD_LIST {
