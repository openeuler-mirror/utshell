...
$cmdName -> 
    ...
    [eval] Evaluate conditional expression.
    ...
    [return] Wait for job completion and return exit status.
    ...
    [popd] Removes entries from the directory stack.  With no arguments, removes
    ...
    [dirs] Display the list of currently remembered directories.  Directories
    ...
    [local] Remember or display program locations.
